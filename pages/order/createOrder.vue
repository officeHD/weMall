	...
	<view>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{shopInfo.total_price}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">优惠券优惠总金额</text>
				<text class="cell-tip red">-￥{{shopInfo.coupon_price}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">满减总金额</text>
				<text class="cell-tip red">-￥{{shopInfo.reduce_price}}</text>
			</view>
			<view class="yt-list-cell b-b">
		...
		<view class="footer">
			<view class="price-content">
				...
				<text class="price">{{shopInfo.pay_price}}</text>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (res.data.code == 200) {
				...
				this.shopInfo = res.data.data.total;
			}
			console.log(res);
		},
		methods: {
			...
			submit() {
				uni.redirectTo({
					url: `/pages/money/pay?id=${this.shopInfo.co_order_id}`
				}); 
			},
			stopPrevent() {}
		}
